...
def playGame(wordList):
    ...
    while True:
        ...
        elif users_game_input == "e":
            return None

        else:
            game_count = game_count + 1

            human_or_pc = input( "Enter u to have yourself play, c to have the computer play: ")
            while human_or_pc not in ["u", "c", "U", "C"]:
                print("Invalid command.")
                human_or_pc = input( "Enter u to have yourself play, c to have the computer play: ")

            if users_game_input == "n":
                hand = dealHand(n)
